...
REQUIRED_FILES = [
    ...
    "desktop/src/lib/stream-event-contract.ts",
    "docs/PRODUCT_MAP.md",
    "docs/PARITY_MATRIX.md",
    "docs/ARCHITECTURE.md",
    "docs/ERROR_STATE_MATRIX.md",
    "docs/RELEASE_PROCESS.md",
    "docs/REFERENCE_SCREENS.md",
    "README.md",
    "schemas/stream-event.schema.json",
    "scripts/generate_stream_event_contract.py",
    ...
    "tests/fixtures/stream-traces/gemini-session-send.jsonl",
    "tests/fixtures/stream-traces/claude-critic-writer.jsonl",
    "tests/fixtures/stream-traces/claude-critic-critic.jsonl",
    "tests/fixtures/stream-traces/codex-critic-critic.jsonl",
    "tests/fixtures/stream-traces/session-with-stderr.jsonl",
    "tests/fixtures/stream-traces/session-with-diff-snapshot.jsonl",
    "tests/fixtures/stream-traces/session-with-review-finding.jsonl",
    "tests/fixtures/stream-traces/interrupted-session.jsonl",
    "tests/fixtures/stream-traces/provider-error.jsonl",
    "tests/fixtures/stream-traces/bridge-recovery-after-interrupted-run.jsonl",
]
CODE_PATHS = [
